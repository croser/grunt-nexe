...
module.exports = function(grunt) {
  return grunt.registerTask('nexe', 'create single executable file by nexe', function() {
    var done, flags, input, option, output, temp, version, _ref;
    done = this.async();
    _ref = grunt.config('nexe'), input = _ref.input, output = _ref.output, flags = _ref.flags, version = _ref.version, temp = _ref.temp;
    option = {
      input: path.join(process.cwd(), input),
      output: path.join(process.cwd(), output),
      flags: flags !== void 0 ? flags : false,
      nodeVersion: version !== void 0 ? version : 'latest',
      nodeTempDir: temp !== void 0 ? temp : '/tmp'
    };
